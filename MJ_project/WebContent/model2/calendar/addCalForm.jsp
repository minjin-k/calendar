...
<body>
<form action="addCal.do" name="f" method="post">
<input type="hidden" name="id" value="${sessionScope.login}">
<table>
   <caption style="font: bold; ">일정 등록</caption>
      ...
      <tr><td colspan="3" style="background-color: #fcf5f9;">&nbsp;과정명<br>
      			<select style="width:95%; height: 25px;" name="major" id="major">
      ...
      <tr><td colspan="3">&nbsp;제목<br><input type="text" name="subject" style="width: 95%; height: 25px;"></td></tr>
      <tr><td colspan="3" style="background-color: #fcf5f9;">&nbsp;내용<br><textarea rows="10" name="content"  style="width: 95%"></textarea></td></tr>
      <tr><td colspan="3" style="text-align: center; ">
      		<input class="button" style="width: 20%; height: 50px;" type="button" value="확인" id ="btn" OnClick="javascript:add_submit()">
